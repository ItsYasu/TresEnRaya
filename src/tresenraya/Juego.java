...
public class Juego extends javax.swing.JFrame {
    ...
    public void iniciarJuego() {
        LogicaJuego logicaJuego = new LogicaJuego(0, 0, 0); // Instancia del objeto "LogicaJuego"
        logicaJuego.iniciarPartida(matriz, jPanel4); // Llama al método iniciarPartida(), pasándole la matriz y el panel
        clearButtons();
    }
